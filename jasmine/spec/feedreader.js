    ...
    */
    ...
    describe('The menu', function() {
         ...
         */
          ...
          */
          ...
          it('menu should changes visibility when the menu icon is clicked', function() {
            $menuIcon.click();
    ...
    describe('New Feed Selection', function() {
         ...
         */
          ...
          it('should changes content of .feed', function() {
               expect(feedContents).not.toEqual(newFeedContents);
          });
    });
